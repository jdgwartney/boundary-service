...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `v_service_check_configs` (`serviceId` INT, `serviceName` INT, `serviceCheckId` INT, `serviceCheckName` INT, `serviceCheckEnabled` INT, `serviceTestId` INT, `serviceTestName` INT, `serviceTestEnabled` INT, `serviceTypeName` INT, `serviceTypeTableName` INT, `configId` INT, `pingHost` INT, `pingTimeout` INT, `portHost` INT, `portPort` INT, `sshHost` INT, `sshPort` INT);
