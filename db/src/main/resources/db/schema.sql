...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `v_service_checks` (`serviceCheckId` INT, `serviceCheckName` INT, `serviceCheckEnabled` INT, `serviceTestId` INT, `serviceTestName` INT);
